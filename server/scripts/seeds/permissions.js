const data = [
  ...
  { code: 'invitations:view', name: 'Ver invitaciones', description: 'Permite ver las invitaciones enviadas' },
  { code: 'invitations:send', name: 'Enviar invitaciones', description: 'Permite enviar invitaciones por email o WhatsApp' },
  { code: 'invitations:manage', name: 'Gestionar invitaciones', description: 'Permite reenviar y cancelar invitaciones' },
