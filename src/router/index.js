...
const routes = [
  {
    ...
    children: [
      ...
      {
        path: '/business/venues/:id/instagram',
        name: 'VenueInstagram',
        component: () => import('@/views/venues/InstagramConnectionView.vue'),
        props: true,
        meta: { breadcrumb: 'Instagram - CabanIA' },
      },
      {
      ...
      },
      {
        ...
        meta: { breadcrumb: 'Registrar Depósito' },
      },
      {
        ...
        component: () => import('@/views/deposits/DepositFormView.vue'),
        props: true,
        meta: { breadcrumb: 'Editar Depósito' },
      },
      {
        ...
        props: true,
        meta: { breadcrumb: 'Detalle de Depósito' },
      },
      {
        path: '/analytics',
        name: 'Analytics',
